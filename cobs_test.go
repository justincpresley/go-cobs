...
func TestNewStuff(t *testing.T) {
	...
	raw := []byte{0x00, 0x00, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x00, 0x00}
	encode := Encode(raw, config)
	fmt.Println(raw)
	fmt.Println(encode)
	decode := Decode(encode, config)
